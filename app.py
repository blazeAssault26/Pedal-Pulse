...
def show_predict_page():
    ...
    temperature_input = st.number_input("Temperature (°C)", min_value=-50.0, max_value=50.0, value=20.0, step=1, key="temperature")
    ...
    visibility_input = st.number_input("Visibility (10m)", min_value=0.0, max_value=3000.0, value=1000.0, step=100, key="visibility")
    ...
    rainfall_input = st.number_input("Rainfall (mm)", min_value=0.0, max_value=100.0, value=0.0, step=1, key="rainfall")
